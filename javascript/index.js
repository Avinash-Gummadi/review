...
function ShowHideAgency1() {
  ...
  if (mob_wl_ag_matter.style.display === "block") {
    ...
    $('.mob_wl_arrow1').removeClass('is-expanded');
  } else {
    mob_wl_ag_matter.style.display = "block";
    $('.mob_wl_arrow1').addClass('is-expanded');
  }
}
function ShowHideAgency2() {
  ...
  if (mob_wl_ag_matter.style.display === "block") {
    mob_wl_ag_matter.style.display = "none";
    $('.mob_wl_arrow2').removeClass('is-expanded');
  } else {
    mob_wl_ag_matter.style.display = "block";
    $('.mob_wl_arrow2').addClass('is-expanded');
  }
}
...
function ShowHideAgency3() {
  ...
  if (mob_wl_ag_matter.style.display === "block") {
    mob_wl_ag_matter.style.display = "none";
    $('.mob_wl_arrow3').removeClass('is-expanded');
  } else {
    mob_wl_ag_matter.style.display = "block";
    $('.mob_wl_arrow3').addClass('is-expanded');
  }
}
...
function ShowHideAgency4() {
  ...
  if (mob_wl_ag_matter.style.display === "block") {
    mob_wl_ag_matter.style.display = "none";
    $('.mob_wl_arrow4').removeClass('is-expanded');
  } else {
    mob_wl_ag_matter.style.display = "block";
    $('.mob_wl_arrow4').addClass('is-expanded');
  }
}
...
function ShowHideAgency5() {
  ...
  if (mob_wl_ag_matter.style.display === "block") {
    mob_wl_ag_matter.style.display = "none";
    $('.mob_wl_arrow5').removeClass('is-expanded');
  } else {
    mob_wl_ag_matter.style.display = "block";
    $('.mob_wl_arrow5').addClass('is-expanded');
  }
}
...
function ShowHideAgency6() {
  ...
  if (mob_wl_ag_matter.style.display == "block") {
    mob_wl_ag_matter.style.display = "none";
    $('.mob_wl_arrow6').removeClass('is-expanded');
  } else {
    mob_wl_ag_matter.style.display = "block";
    $('.mob_wl_arrow6').addClass('is-expanded');
  }
}
...
function ShowHideAgency7() {
  ...
  if (mob_wl_ag_matter.style.display == "block") {
    mob_wl_ag_matter.style.display = "none";
    $('.mob_wl_arrow7').removeClass('is-expanded');
  } else {
    mob_wl_ag_matter.style.display = "block";
    $('.mob_wl_arrow7').addClass('is-expanded');
  }
}
...
// our services
var services_top = $('#our_services').offset().top;
    $("#our_services_id").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: services_top }, "slow");
        return false;
    });
    $("#our_services_footer").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: services_top }, "slow");
        return false;
    });
    $("#our_services_menu").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: services_top }, "slow");
        $(".navbar-collapse").removeClass("show");
        // $("body").removeClass("offcanvas-active");
...
// our dealings
  var dealings_top = $('#our_dealings').offset().top;
    $("#our_dealings_id").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: dealings_top }, "slow");
        return false;
    });
    $("#our_dealings_footer").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: dealings_top }, "slow");
        return false;
    });
    $("#our_dealings_menu").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: dealings_top }, "slow");
        $(".navbar-collapse").removeClass("show");
        return false;
...
// ecommerce
  var ecommerce_top = $('#ecommerce').offset().top;
    $("#ecommerce_id").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: ecommerce_top }, "slow");
        return false;
    });
    $("#ecommerce_footer").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: ecommerce_top }, "slow");
        return false;
    });
    $("#ecommerce_menu").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: ecommerce_top }, "slow");
        $(".navbar-collapse").removeClass("show");
        return false;
...
// wl Agency
  var wl_agency_top = $('#wl_agency').offset().top;
    $("#wl_agency_id").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: wl_agency_top }, "slow");
        return false;
    });
    $("#wl_agency_footer").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: wl_agency_top }, "slow");
        return false;
    });
    $("#wl_agency_menu").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: wl_agency_top }, "slow");
        $(".navbar-collapse").removeClass("show");
        return false;
...
// footer
  var footer_top = $('#footer').offset().top;
    $("#footer_id").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: footer_top }, "slow");
        return false;
    });
    $("#footer_footer").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: footer_top }, "slow");
        return false;
    });
    $("#footer_menu").click(function(event) {
        event.preventDefault();
        $("html, body").animate({ scrollTop: footer_top }, "slow");
        $(".navbar-collapse").removeClass("show");
        return false;
